...
/// <summary>
/// Reads the imported DB-dictionary back out of <see cref="ModuleEDatabase"/> and renders a single
...
public sealed class HtmlReportGenerator
{
    ...
    public string Generate(ModuleEDatabase database, string databaseName)
    {
    ...
    private static string SanitizeFileName(string name)
    {
        ...
        return sanitized.Length == 0 ? "ModuleE" : sanitized;
    }
