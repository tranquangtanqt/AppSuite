...
/// per logic - no sheet HTML) embedded inline as JSON, exactly like ModuleG's index. Embedded rather
/// than fetched at runtime for the same reason as ModuleG: opening a local file via file:// and
