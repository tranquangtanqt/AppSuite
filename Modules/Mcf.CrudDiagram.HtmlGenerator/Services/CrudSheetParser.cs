...
/// <summary>
/// The single semantic parser for every CRUD図 logic sheet (unlike Mcf.Screen.HtmlGenerator, which needs 1 parser per
...
///   Mcf.Screen.HtmlGenerator's 3-row stacked header) - モジュールID/モジュール名/文書番号/Version/Rev. on row 1,
