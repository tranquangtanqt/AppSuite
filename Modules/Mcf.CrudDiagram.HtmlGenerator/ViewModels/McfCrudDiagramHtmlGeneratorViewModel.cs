...
namespace Mcf.CrudDiagram.HtmlGenerator.ViewModels;
...
/// Mirrors McfScreenHtmlGeneratorViewModel's style (CommunityToolkit.Mvvm, manually constructed - no DI container).
/// </summary>
public sealed partial class McfCrudDiagramHtmlGeneratorViewModel : ObservableObject
{
    ...
    public McfCrudDiagramHtmlGeneratorViewModel()
    {
    ...
    /// DispatcherQueue instead (same fix Mcf.Screen.HtmlGenerator needed).</summary>
