namespace Mcf.CrudDiagram.HtmlGenerator.Models;

/// <summary>One imported "CRUD図" logic sheet - unlike Mcf.Screen.HtmlGenerator (1 record per *file*, many sheets each),
