...
namespace SharedUI.Controls.DesignGuidance;

/// <summary>Card wrapper for a titled color/design-guidance example, with description text and example content.</summary>
